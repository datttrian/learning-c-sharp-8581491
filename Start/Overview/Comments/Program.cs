...
namespace Comments
{
    class Program
    {
        ...
        /// </summary>
        /// <param name="args">An array of string arguments from the
        /// command line</param>
        /// <returns>
        /// No return value
        /// </returns>
        ...
        {
            // Single lien comments start with two slashes
            // You can have as many of these as you want
            Console.WriteLine("Hello World!");
            /* Multiple line comments start with a slash and a star and can
            continue for several lines until a closing star and slash are
            encountered
            */
        }
    }
